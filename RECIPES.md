...
clai transforms text. Fetching content from YouTube, web pages, or other platforms is a different responsibility — one that belongs in separate tools composed by pipes.
...
- **Prompts are files.** Edit them: `$EDITOR $(clai prompts path summarize)`
