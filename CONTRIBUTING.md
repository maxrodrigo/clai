...
- **Flags:** New flags must align with [MANIFEST.md](MANIFEST.md). If it conflicts, update the manifest in the same PR.
...
See [ADVANCED.md](ADVANCED.md) for the full prompt authoring principles and evaluation checklist.
